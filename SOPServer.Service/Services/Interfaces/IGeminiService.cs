...
namespace SOPServer.Service.Services.Interfaces
{
    ...
    public interface IGeminiService
    {
        ...
        Task<List<string>> OutfitSuggestion(string occasion, string usercharacteristic, string? weather, string? userInstruction);
        Task<OutfitSelectionModel> ChooseOutfit(string occasion, string usercharacteristic, List<QDrantSearchModels> items, string? weather, string? userInstruction);
