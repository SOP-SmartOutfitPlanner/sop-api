...
namespace SOPServer.Service.Services.Interfaces
{
    public interface IGeminiService
    {
        ...
        Task<GeminiOutfitGenerationModel?> GenerateOutfitDescription(string userContext);
        Task<GeminiOutfitSelectionResponse?> SelectBestOutfit(string userContext, List<CategoryItemCandidates> candidates);
    }
}
