...
namespace SOPServer.Service.Services.Implements
{
    public class SaveOutfitFromPostService : ISaveOutfitFromPostService
    {
        ...
        public async Task<BaseResponseModel> GetSavedOutfitsByUserAsync(long userId, PaginationParameter paginationParameter)
        {
            ...
            var savedOutfits = await _unitOfWork.SaveOutfitFromPostRepository.ToPaginationIncludeAsync(
                paginationParameter,
                include: query => query
                    .Include(s => s.Outfit)
            ...
            var models = _mapper.Map<Pagination<SaveOutfitFromPostDetailedModel>>(savedOutfits);
