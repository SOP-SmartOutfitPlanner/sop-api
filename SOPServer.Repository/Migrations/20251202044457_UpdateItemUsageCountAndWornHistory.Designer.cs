...
namespace SOPServer.Repository.Migrations
{
    ...
    [Migration("20251202044457_UpdateItemUsageCountAndWornHistory")]
    partial class UpdateItemUsageCountAndWornHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SOPServer.Repository.Entities.PostItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("Id")
                        .HasName("PK__PostItem__3214EC07");

                    b.HasIndex("ItemId")
                        .HasDatabaseName("IX_PostItem_ItemId");

                    b.HasIndex("PostId")
                        .HasDatabaseName("IX_PostItem_PostId");
            ...
            modelBuilder.Entity("SOPServer.Repository.Entities.PostOutfit", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__PostOutfit__3214EC07");

                    b.HasIndex("OutfitId")
                        .HasDatabaseName("IX_PostOutfit_OutfitId");

                    b.HasIndex("PostId")
                        .HasDatabaseName("IX_PostOutfit_PostId");

                    b.ToTable("PostOutfit", (string)null);
                });
